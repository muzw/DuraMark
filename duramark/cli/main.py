...
def main():
    ...
    embed_parser.add_argument("--ref_text", required=True, help="Reference text SCP file")
    embed_parser.add_argument("--ref_wav", required=True, help="Reference audio SCP file")
